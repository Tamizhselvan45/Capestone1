...
with col1:
    ...
    if Get_data or st.session_state.Get_state:
        ...
        mydb = client['Youtube_Data_Analysis']

        # create a collection
        collection = mydb['Youtube_Collected_da']
...
connect_for_question = pymysql.connect(host='localhost', user='root', password='1234', db='youtube_db')
